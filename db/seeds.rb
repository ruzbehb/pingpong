...
players = Player.create([{email: "ruzbehb@yahoo.com", name: "Ruzbeh Bacha", password: "12345678", password_confirmation: "12345678", first_name: 'Ruzbeh', last_name: 'Bacha', sex: 'Male', current_location: 'London, United Kingdom', hometown: 'Mumbai, India', fb_url: "http://graph.facebook.com/509597657/picture?type=square"},
