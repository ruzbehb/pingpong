...
(function() {
  ...
  window.InfoBoxBuilder = (function(_super) {
    __extends(InfoBoxBuilder, _super);

    function InfoBoxBuilder() {
      _ref = InfoBoxBuilder.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  window.RichMarkerBuilder = (function(_super) {
    __extends(RichMarkerBuilder, _super);

    function RichMarkerBuilder() {
      _ref1 = RichMarkerBuilder.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
...
(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_GB/all.js#xfbml=1&appId=219021668280216";
...
(function() {
  $(function() {
    var channel, connection, flipBoard, id, isOddNumberedGame, p1_id, p2_id;
    id = $('.match').data('id');
    p1_id = $('#p1-name').data('id');
    p2_id = $('#p2-name').data('id');
    isOddNumberedGame = function(match) {
      return (match.p1games + match.p2games) % 2 !== 0;
    };
    flipBoard = function(match) {
      return $('.match').toggleClass('flipped', isOddNumberedGame(match));
    };
    $("#p1-points, #p2-points, #p1-back, #p2-back").on('click', function(e) {
      e.preventDefault();
      return $.ajax("/api/matches/" + id, {
        data: {
    ...
    return channel.bind('edit', function(match) {
      var $scope, appElement;
      ...
      if (appElement) {
        ...
        return $scope.$apply(function() {
          if (Boolean(match.new_game)) {
            return $scope.clearPlayerProgressRecords();
          } else {
            return $scope.updateRally(match['rally_winner_index'], Boolean(match.decrement));
          }
        });
      }
    });
